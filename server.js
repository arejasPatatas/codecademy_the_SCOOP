...
//using js-yaml (instead of figg)
function loadDatabase () {
  const fs = require('fs');
  const yaml = require('js-yaml');
  
  try {
      let fileContents = fs.readFileSync('./dba.yaml', 'utf8');
...
fs.writeFileSync('dba.yaml', yamlStr, 'utf8');
}
//to implement: just call it after each change function?
